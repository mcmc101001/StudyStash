      ...
      <div className="h-full w-1/3 pr-5">
        <section className="relative rounded-xl bg-slate-300 p-6 dark:bg-slate-700">
          ...
          <div className="my-2">
            ...
            <p className="max-h-[120px] overflow-y-scroll scroll-smooth whitespace-break-spaces break-words scrollbar-thin scrollbar-track-transparent scrollbar-thumb-slate-400">
              {profileUser.bio ||
